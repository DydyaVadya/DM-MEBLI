...
hrScrollingList.addEventListener("transitionend",
function(){
...
_document.elementFromPoint(e.pageX, e.pageY
)==cont
){
pushed=1;
...
var scroll=new SmoothScroll('.page-nav a[href*="#"]',{
header: ".page-header"
});
...
jQuery(function (){
if(jQuery('.btn-send-data').length){
var $btnSendData=jQuery('.btn-send-data');
$btnSendData.on('click',function (event){
var $this=jQuery(this),
$form=$this.parents("form"),
$input=$form.find('input'),
$success=jQuery($this.attr('data-target')),
...
var $zoomModal=jQuery('.zoom-modal');
...
jQuery('.gallery-for').on('beforeChange', function(event, slick, currentSlide, nextSlide){
var content_image=jQuery(this).find('.slick-slide').eq(nextSlide).find('.zoom'),
zoom_image=content_image.attr('data-zoom-image');
jQuery('.zoomContainer .zoomWindowContainer > div').css('background-image', 'url(' + zoom_image + ')');
});
}});
});
(function(wiondow, $){
...
<div class="col-sm-5 align-self-center"><a href="tel:+380936666666" target="_blank" title="(093) 666 - 66 - 66">(093) 666 - 66 - 66</a></div>
</div>
</div>`);
}else{
$('#discuss-modal .modal-content').html(`<div class="modal-container">
...
console.log(4);
$idElement.find('.tab-content-id').css('max-height', '1200px');
